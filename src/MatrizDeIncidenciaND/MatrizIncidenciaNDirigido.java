...
import java.awt.Container;
 ...
 public class MatrizIncidenciaNDirigido extends JFrame implements ActionListener{
    ...
    public String consideraciones(int[][] mat){
        ...
        for(int a=0;a<m;a++){
         ...
         if(elemA==(m)){
                ...
                consideracion2=ConsideracionesIND.c2(mat, n, m);
    ...
    public MatrizIncidenciaNDirigido(){
        ...
        mayor.setBackground(Color.darkGray);
         ...
         for (int i=0;i<matriz.length;i++){
                ...
                setTitle("Matriz de incidencia para grafos no dirigidos");
                setSize(807,707);
    ...
    public void actionPerformed(ActionEvent evento){
       int bandera=0;
       int[][] indicencia=new int[pregunta][pregunta2];
                            ...
                            for (int i=0;i<pregunta;i++)
                                for(int j=0;j<pregunta2;j++){
                                    if((matriz[i][j].getText()).contains("1")||(matriz[i][j].getText()).contains("2")||(matriz[i][j].getText()).contains("0")){   
                                        indicencia[i][j]=Integer.parseInt(matriz[i][j].getText());
                                    }else
                                         throw new Exception("Solo se aceptan 1,0,2");
                                 }
                            String resultado=consideraciones(indicencia);
