...
import java.awt.Container;
 ...
 public class MatrizC extends JFrame implements ActionListener{
    ...
    public String consideraciones(int[][] mat){
        ...
        String comprobacion="",total="",c="",co3="";
        for(int i = 0; i < n; i++){
            ...
            for(int u = 0; u < n; u++){
                ...
                if(vectorCircuitos[u] == 1){
                    comprobacion+=("\nEl circuito "+(i+1)+" se repite con el  circuito: "+(u+1));
                    contador++;
                }
            }
           contador = 0;
        ...
        if(bandera==1&&  bandera2==1){
             ...
             co3=consideraciones.c3(mat, n, m);
            total=c+comprobacion+co3;
